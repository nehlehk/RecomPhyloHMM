...
params.out =  "${PWD}/short_philobacteria"
...
process RMSE_summary {
     ...
     publishDir "$PWD/short_philobacteria/Summary_Results", mode: "copy"
     maxForks 1
...
workflow {
    ...
    collectedRMSE_HMM_two = phyloHMM_two.out.rmse_phylohmm_two.collectFile(name:"rmse_phylohmm_two.csv",storeDir:"${PWD}/short_philobacteria/Summary_Results", keepHeader:false , sort: false) 
    
    collectedRMSE_HMM_four = phyloHMM_four.out.rmse_phylohmm_four.collectFile(name:"rmse_phylohmm_four.csv",storeDir:"${PWD}/short_philobacteria/Summary_Results", keepHeader:false , sort: false)
    
    collectedRMSE_CFML = CFML_result.out.rmse_CFML.collectFile(name:"rmse_CFML.csv",storeDir:"${PWD}/short_philobacteria/Summary_Results", keepHeader:false , sort: false) 
...
//    RMSE_summary(collectedRMSE_HMM_four,collectedRMSE_CFML)
    ...
    collectedCMP_tree = TreeCmp.out.Comparison.collectFile(name:"all_cmpTrees.result",storeDir:"${PWD}/short_philobacteria/Summary_Results", keepHeader:false , sort: false) 
