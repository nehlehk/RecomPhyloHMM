...
//     conda "conda-forge::matplotlib=3.3.4 pandas conda-forge::seaborn"
     ...
     """
       python3.8  $PWD/bin/rmse_plot_states.py -t rmse_phylohmm_two.csv  -f rmse_phylohmm.csv -c rmse_CFML.csv
...
workflow {
    ...
    collectedRMSE_HMM_two = phyloHMM_two.out.rmse_phylohmm_two.collectFile(name:"rmse_phylohmm_two.csv",storeDir:"${PWD}/results_4states/Summary_Results", keepHeader:false , sort: false) 
    
    RMSE_summary_states(collectedRMSE_HMM_two,collectedRMSE_HMM,collectedRMSE_CFML)
